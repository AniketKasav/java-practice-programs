/*Q49. There is a group of NN friends who wish to enroll in a course together. 
The course has a maximum capacity of MM students that can register for it. 
If there are KK other students who have already enrolled in the course, determine if it will still be possible for all the NN friends to do so or not.
Input Format
...
public class Ass49{
	public static void main(String[] args){
		...
		int t=sc.nextInt();
		while(t-->0){	
		System.out.println("Enter three values the size of the friend group,the capacity of the course and the number of students already registered for the course");
		int n=sc.nextInt();
		int m=sc.nextInt();
		int k=sc.nextInt();
		if(n<=m-k){
