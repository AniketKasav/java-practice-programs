...
public class Ass48 {
	public static void main(String[] args){
		...
		System.out.print("Enter the present credits score :");
		int s=sc.nextInt();
		if(s>=750){
			System.out.print("Possible to access CRED programs");
		}else{
			System.out.print("Not possible to access CRED programs");
